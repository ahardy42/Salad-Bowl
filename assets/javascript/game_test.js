$(document).ready(function () {
    ...
    test version sets the players and teams before playing!!!

    */

    teams.push(
        new Team("Winners"), new Team("Losers")
    );
    teams[0].players.push("Andy", "Paul", "Jesse");
    teams[1].players.push("Katie", "Theo", "Sarah");
    wordList = ["monkey", "giraffe", "dog", "cat", "pillow", "clown", "bat", "dog", "baloon", "steven spielburg", "macho man randy savage"];
    console.log("teams", teams);
